...
import 'package:tacti_track/models/view/components/popup_desktop.dart';
...
import '../../../cubit/tacti_track/cubit/TactiTrack_cubit.dart';
      ...
      child: BlocConsumer<TactiTrackCubit, TactiTrackState>(
        listener: (context, state) {
          if (state is PickDataSucssessState) {
            showDialog(
                context: context,
                builder: (context) => PopupDesktop(
                    onTapStart: () {
                      Navigator.pop(context);

                      TactiTrackCubit.get(context).snedData(
                          isVideo: TactiTrackCubit.get(context).isVideo!);
                    },
                    isVideo: TactiTrackCubit.get(context).isVideo!));
          }
